#!/usr/bin/env python3
"""
Module that provides simple pagination function.
...
from a CSV file containing popular names.
"""
...
class Server:
    ...
    def __init__(self):
        """
        Initialise a new server instance with a cached dataset set to None.
        """
        self.__dataset = None
